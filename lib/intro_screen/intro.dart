...
import 'package:bhagyoday/intro_screen/data.dart';
  ...
  Widget _buildPageIndicator(bool isCurrentPage){
    return Container(
      ...
      decoration: BoxDecoration(
        color: isCurrentPage ? LightColor.red : LightColor.midnightBlue,
    ...
    return Container(
      decoration: BoxDecoration(
          gradient: LinearGradient(
              colors: [const Color(0xffF72804), const Color(0xffF72804)])),
      child: Scaffold(
